...
<div class="tabs" id="tabsBar">
  <button class="tab-btn active" onclick="switchTab(this,'p7')">📅 2026.6.2–6.8</button>
  <button class="tab-btn" onclick="switchTab(this,'p65')">📅 2026.5.26–6.1</button>
...
<div class="period-content active" id="p7">
  <div class="overview-card">
    ...
    <table class="overview-table">
      ...
      <tbody>
        <tr><td>1</td><td><div class="dim-cell"><img src="${ICONS.pay}" alt="">微信支付</div></td><td>内测AI支付打通Agent关键一环；自动扣款规则大升级（6月14日生效）</td><td style="text-align:center">★★★</td></tr>
        <tr><td>2</td><td><div class="dim-cell"><img src="${ICONS.open}" alt="">微信开放平台</div></td><td>微信AI向全量小程序开发者开放接口，两种接入模式任选（6月8日）</td><td style="text-align:center">★★★</td></tr>
        <tr><td>3</td><td><div class="dim-cell"><img src="${ICONS.store}" alt="">微信小店</div></td><td>功能调整汇总-20260605；奢品珠宝类目新增（6.12）；618大促激励上线</td><td style="text-align:center">★★★</td></tr>
        <tr><td>4</td><td><div class="dim-cell"><img src="${ICONS.mp}" alt="">公众号</div></td><td>留言配图增至9张 + 辟谣能力开放；图标变更+图片搜索更新</td><td style="text-align:center">★★</td></tr>
        <tr><td>5</td><td><div class="dim-cell"><img src="${ICONS.channels}" alt="">视频号</div></td><td>直播安全信用分规则更新（6.4生效）；空间美学博主认证；Mac直播+礼物投稿开放</td><td style="text-align:center">★★</td></tr>
      </tbody>
    </table>
  </div>
  ...
  <div class="dim-block">
    ...
    <div class="dim-body">
      <div class="item new"><div class="item-title"><span class="tag new">功能升级</span>公众号留言区配图数量增至最多9张（6月6日）</div><p>每条留言最多可配9张图，以宫格形式展示，点击可查看大图、滑动切换、长按保存。</p></div>
      <div class="item new"><div class="item-title"><span class="tag new">灰度功能</span>公众号图标由"书本"改为"叶片"样式（6月6日灰度中）</div><p>全新叶片图标逐步覆盖，目前仍在灰度阶段，仅部分用户可见。</p></div>
      <div class="item new"><div class="item-title"><span class="tag new">能力升级</span>微信图片搜索能力更新：购物直达+表格识别转腾讯文档（6月2日）</div><p>长按图片"搜一搜"新增购物直达（识别商品图→微信小店商品链接）；表格截图可自动识别并一键转换为可编辑腾讯文档表格。</p></div>
      <div class="item new"><div class="item-title"><span class="tag new">新功能</span>公众号辟谣能力正式开放（微信公开课6月9日汇总）</div><p>面向医疗/政府/学校/专业机构及已认证科普类个人创作者开放，支持「主动辟谣」和「授权辟谣」两种方式，辟谣内容在官方辟谣页面和推荐场景展示并支持跳转，帮助专业创作者增加曝光。</p></div>
    </div>
  </div>
  ...
  <div class="dim-block">
    ...
    <div class="dim-body">
      <div class="item new"><div class="item-title"><span class="tag new">重大能力</span>微信AI向全量小程序开发者开放接口（6月8日）</div><p>开发者可在小程序管理后台"AI能力"板块一键开通。提供"自动模式"（平台自动分析源码）和"开发模式"（自主个性化开发）两种接入方式，接入后小程序可被微信AI推荐和调用。</p><a class="link-btn" href="https://www.stcn.com/article/detail/3949573.html" target="_blank">查看公告</a></div>
      <div class="item new"><div class="item-title"><span class="tag new">能力升级</span>小程序多媒体能力升级（6月4日）</div><p>新增相机组件（自定义拍照/录像界面）；录音功能优化（支持更多格式、边录边传）；音频播放功能升级；视频播放/地图/画布功能持续优化。</p></div>
      <div class="item new"><div class="item-title"><span class="tag new">模型升级</span>小程序成长计划模型焕新：支持混元Hy3 preview（微信公开课6月9日汇总）</div><p>微信AI小程序成长计划云开发资源正式支持腾讯混元最新大模型Hy3 preview；小游戏开发者通过【MP后台-功能-游戏能力地图】参与，每款报名小游戏可获1亿混元Token+1万张混元生图额度，还可解锁贴图号话题运营扶持。</p></div>
    </div>
  </div>
  ...
  <div class="dim-block">
    ...
    <div class="dim-body">
      <div class="item rule"><div class="item-title"><span class="tag rule">规则更新</span>视频号直播安全信用分运营规则更新（6月4日生效）</div><p>平台根据主播历史违规情况计算直播安全信用分（满分100分），对多次违规主播采取阶梯处置。规则为动态文档，将持续修订。</p><a class="link-btn" href="https://support.weixin.qq.com/cgi-bin/mmsupportacctnodeweb-bin/pages/6OF8Ij9jSQsH96km" target="_blank">查看规则</a></div>
      <div class="item new"><div class="item-title"><span class="tag new">新功能</span>视频号空间美学博主认证上线</div><p>面向家居家装设计师及空间规划创作者开放专属认证，享有专属标识、流量奖励、搜索排前等权益，还可参与微信小店带货者相关激励活动。</p></div>
      <div class="item new"><div class="item-title"><span class="tag new">能力升级</span>鸿蒙版微信更新：视频号直播预约+图片评论+横屏观看（6月8日）</div><p>鸿蒙版微信一次性上线近20项功能，视频号支持直播预约、图片动态浏览、图片评论发表和浏览；直播间支持位置标记、发表情包。</p></div>
      <div class="item new"><div class="item-title"><span class="tag new">新功能</span>Mac端视频号直播伴侣正式上线（微信公开课6月9日汇总）</div><p>Mac系统电脑可一键搭建直播间、实现视频号一键开播，目前基础功能已全覆盖，支持知识分享、才艺展示、聊天互动等直播场景。</p></div>
      <div class="item new"><div class="item-title"><span class="tag new">新功能</span>视频号直播礼物开放投稿（微信公开课6月9日汇总）</div><p>直播礼物投稿通道正式对外开放，设计师可参与礼物创作，作品上线后可作为直播间打赏选项，创作者可获得相应收益。</p></div>
    </div>
  </div>
  ...
  <div class="dim-block">
    ...
    <div class="dim-body">
      ...
      <div class="item rule"><div class="item-title"><span class="tag rule">规则公示</span>商家和带货者账号体系管理规则修订公示（6月12日生效）</div><p>修订视频号和公众号带货规则，更新账号关联次数计算方式：1个视频号同一时间只能关联1个商家，1个自然年内最多变更2次。</p><a class="link-btn" href="https://store.weixin.qq.com/chengzhang/webdoc/wiki/9456/f961796a33a9000e/growth_center_rule_for_store/28?bpath=%252Frule%252Fshop" target="_blank">查看公示</a></div>
      <div class="item rule"><div class="item-title"><span class="tag rule">类目调整</span>新增"奢品珠宝"二级类目（6月12日起生效）</div><p>在"珠宝首饰"大类下新增"奢品珠宝"二级类目，同步上线配套细分三级类目，执行专属入驻管控标准。</p><a class="link-btn" href="https://shuaishou.com/news/81882.html" target="_blank">查看公告</a></div>
      <div class="item rule"><div class="item-title"><span class="tag rule">新规公示</span>「二级类目-二手奢侈品箱包」定向准入和清退标准新规（6月15日生效）</div><p>开放"二手奢侈品箱包"类目定向准入，对主体要求、APP/小程序要求、类目互斥要求作出明确规定。</p><a class="link-btn" href="https://store.weixin.qq.com/chengzhang/webdoc/wiki/9484/bd91e5c497620227/growth_center_rule_for_store/28?bpath=%252Fhome%252Fweekly-rules&sourceType=1" target="_blank">查看新规</a></div>
      <div class="item notice"><div class="item-title"><span class="tag notice">治理公告</span>二手奢侈品商品需提交质检服务中心查验（6月16日起执行）</div><p>2026年6月16日起，"二手奢侈品箱包"类目全量商品发货前需提交微信小店质检服务中心查验，查验通过后由质检中心打包发货。</p><a class="link-btn" href="https://store.weixin.qq.com/chengzhang/webdoc/wiki/9464/f6fb74ab13289546/growth_center_platform_notice/1?bpath=%252Fhome%252Fweekly-rules&sourceType=1" target="_blank">查看公告</a></div>
      <div class="item api"><div class="item-title"><span class="tag api">API调整</span>「获取类目下商品发布规则接口」调整（6月5日）</div><p>新增入参brand_id字段，支持查询品牌发品规则，减少发品失败。</p><a class="link-btn" href="https://store.weixin.qq.com/chengzhang/webdoc/wiki/9482/6a1dbb739a4896de/growth_center_platform_notice/1?bpath=%252Fnotice" target="_blank">查看公告</a></div>
      <div class="item activity"><div class="item-title"><span class="tag activity">生态动态</span>2026年微信重磅发力视频号团购，本地生活赛道全面布局</div><p>微信依托视频号、小程序、微信支付、腾讯地图等全生态核心能力，面向餐饮、酒旅、景区、健身家政等实体商家推出到店+到家一体化全域运营解决方案。</p><a class="link-btn" href="https://new.qq.com/rain/a/20260605A0914W00" target="_blank">查看报道</a></div>
      <div class="item activity"><div class="item-title"><span class="tag activity">大促激励</span>微信小店618大促激励（微信公开课6月9日汇总）</div><p>参与大场直播的账号最高可获200万点电商成长卡激励；首次推出"618跨店满减补贴"玩法，用户分享消费券还有机会触发额外补贴。小店投放上线"成长陪伴·投放任务"限时激励活动，符合条件商家可在【微信小店管理后台-小店推广-小店投放-概览-成长陪伴·投放任务】查看报名。</p></div>
    </div>
  </div>
  ...
  <div class="dim-block">
    ...
    <div class="dim-body">
      <div class="item new"><div class="item-title"><span class="tag new">生态动态</span>2026年推客市场规模预计突破1万亿，推客数量规模预计突破2000万</div><p>微信推客市场爆发，视频号开放0粉挂车、微信小店推客模式全面升级。普通人可走短视频带货、私域推客、品牌推客三条赛道。</p></div>
    </div>
  </div>
  ...
  <div class="dim-block">
    ...
    <div class="dim-body">
      <div class="item new"><div class="item-title"><span class="tag new">版本更新</span>企业微信5.0.8版本更新上线（6月3日）</div><p>全新上线"面聊"功能（线下会议记录→线上资产）；智能表格新增"AI技能卡片"（大白话指挥AI数据分析）；待办更新；群聊贴表情能力上线（灰度中）。</p><a class="link-btn" href="https://www.wescrm.com/siyuzhishiku/qiweiyunying/40290.html" target="_blank">查看详情</a></div>
    </div>
  </div>
  ...
  <div class="dim-block">
    ...
    <div class="dim-body">
      <div class="item new"><div class="item-title"><span class="tag new">重大能力</span>微信AI向全量小程序开发者开放接口（6月8日官宣）</div><p>微信开放平台正式宣布面向所有小程序开发者开放微信AI生态接入能力。支持"自动模式"和"开发模式"，接入后小程序可被微信AI推荐和调用。</p><a class="link-btn" href="https://www.stcn.com/article/detail/3949573.html" target="_blank">查看公告</a></div>
    </div>
  </div>
  ...
  <div class="dim-block">
    ...
    <div class="dim-body">
      <div class="item new"><div class="item-title"><span class="tag new">重大能力</span>微信支付内测AI支付，打通Agent关键一环（6月8日）</div><p>微信支付正在与WorkBuddy测试AI支付能力，未来计划面向更多Agent平台开放。用户可在与Agent对话中提出消费需求，Agent可智能推荐并直接完成微信支付。</p><a class="link-btn" href="https://caifuhao.eastmoney.com/news/20260608130624451030610" target="_blank">查看报道</a></div>
      ...
      <div class="item notice"><div class="item-title"><span class="tag notice">合规更新</span>服务商代交资料72小时内删除（5月版协议修订）</div><p>服务商代为收集并提交商户资料时，资料传输至财付通系统后，应在72小时内删除本地暂存副本，不得留存、复制、截取证件照片原件及银行账号信息。</p><a class="link-btn" href="https://caifuhao.eastmoney.com/news/20260602203059756717760" target="_blank">查看公告</a></div>
      <div class="item new"><div class="item-title"><span class="tag new">能力升级</span>跨境支付"外包内用"朋友圈再扩容（6月3日）</div><p>腾讯旗下TenPay Global与PayPal World互联互通，外国友人无需下载新应用，可直接用原有PayPal应用在中国扫微信码支付。</p><a class="link-btn" href="https://www.cnstock.com/commonDetail/724492" target="_blank">查看报道</a></div>
    </div>
  </div>
</div><!-- /p7 -->
...
<div class="period-content active" id="p6">
  ...
  <div class="dim-block">
    ...
    <div class="dim-body">
      ...
      <div class="item"><div class="item-title"><span class="alert-badge">专项治理</span>关于「微信小店生鲜新增开放类目」调整公告 2026/05/20</div><p>生鲜类目下新增若干开放类目，以满足用户购物需求和生鲜商家经营需求。具体新增类目以平台公告页实际展示为准。</p><a class="link-btn" href="https://store.weixin.qq.com/commerce/noticeList" target="_blank">查看公告</a></div>
      <div class="item alert"><div class="item-title">玩具乐器新增定向准入类目：文具类盲盒/其他玩具类盲盒（5月30日起）2026/05/20</div><p>自2026年5月30日起，微信小店一级类目【玩具乐器】下新增定向准入四级类目【文具类盲盒】和【其他玩具类盲盒】，保证金1万元（企业店），个体工商户暂不开放。</p><a class="link-btn" href="https://store.weixin.qq.com/chengzhang/webdoc/wiki/9384/71a0471c5b30061c/growth_center_platform_notice/1?bpath=%252Fhome%252Fweekly-rules" target="_blank">查看公告</a></div>
      <div class="item"><div class="item-title">2026年618大促活动规则更新版 2026/05/21</div><p>618平台大促活动更新：跨店满减补贴活动（5月15日-6月18日）、直播大场激励并行推进；报名截止6月18日；商家不得变相涨价，违者取消激励资格。</p><a class="link-btn" href="https://store.weixin.qq.com/chengzhang/webdoc/wiki/9355/e13ece8503fe0d5c/growth_center_platform_notice/2?bpath=%252Fnotice" target="_blank">查看活动规则</a></div>
    </div>
  </div>
...
<div class="footer">
  <div class="footer-update">
    <span>🕐 最近更新：2026年6月9日</span>
    <span class="footer-next">📅 下次更新：2026年6月16日（周二）</span>
  </div>
